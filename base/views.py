...
def safe_poc(request):
    message,sender_bits,sender_base,n = sender_bits()
    receiver_results,receiver_base = receiver_bits(n,message)
        
    receiver_sample,receiver_key = receiver_check(sender_base, receiver_base, receiver_results)
    sender_sample,sender_key = sender_check(sender_base, receiver_base, sender_bits)
    status = compare(sender_sample,receiver_sample,receiver_sample,sender_sample,receiver_key,sender_key,message)
